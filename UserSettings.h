...
//@brief The `UserSettings` that is responsible for persisting and notifying listeners of any change of these settings.
...
struct EXTERNAL IUserSettings : virtual public Core::IUnknown {
  ...
  // A setting of ON indicates that Players should select a subtitle track for presentation
