...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 3, "method": "org.rdk.OpenCDMi.deinitialize", "params": {"shell": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 18, "method": "org.rdk.OpenCDMi.initialize", "params": {"shell": "", "configline": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 9, "method": "org.rdk.OpenCDMi.getChallengeDataExt", "params": {"challenge": "", "challengeSize": 0, "isLDL": 0}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 17, "method": "org.rdk.OpenCDMi.onKeyStatusUpdate", "params": {"keyID[]": "", "keyIDLength": "", "status": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 26, "method": "org.rdk.OpenCDMi.selectKeyId", "params": {"keyLength": "", "keyId[]": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 28, "method": "org.rdk.OpenCDMi.storeLicenseData", "params": {"licenseData[]": "", "licenseDataSize": 0, "secureStopId": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 15, "method": "org.rdk.OpenCDMi.onError", "params": {"error": "", "sysError": "OCDM_SUCCESS", "errorMessage": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 16, "method": "org.rdk.OpenCDMi.onKeyMessage", "params": {"keyMessage": "", "keyLength": "", "URL": ""}}' http://127.0.0.1:9998/jsonrpc
```
...
```curl
curl -H 'content-type:text/plain;' --data-binary '{"jsonrpc": 2.0, "id": 26, "method": "org.rdk.OpenCDMi.status", "params": {"keyID[]": "", "keyIDLength": ""}}' http://127.0.0.1:9998/jsonrpc
```
